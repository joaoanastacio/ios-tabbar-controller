...
class CityViewController: UIViewController {
  ...
  @objc func showWeatherDetails() {
      ...
      // Create an instance of Details View Controller
      var detailViewController = DetailsViewController()
      
      // Populating variable from Details View Controller
      detailViewController.country = city.icon
      detailViewController.city = city.name
      detailViewController.temperature = city.temp
      detailViewController.summary = city.summary
      
      // Push Details View Controller on Navigation Controller Stack
